...
$mainData = [
  [
    "pTitle" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
    "pList" => [
  ...
  [
    "pTitle" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
    "pList" => [
  ...
  [
    "pTitle" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?",
    "pList" => [
  ...
  [
    "pTitle" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
    "pList" => [
...
<body>
  ...
  <header>
    <div class="container-fluid">
      <div class="row w-50 align-items-center">
        ...
        <div class="col">
          <h4 class="fw-light m-0">Privacy & Termini</h4>
        </div>
      </div>
  ...
  <main>
    <div class="container py-3">
      <!-- mainData (pTitle, pList) -->
      <?php
      // ciclo foreach -> array da ciclare "as" faqBox -> "contiene" l'indice corrente
      foreach ($mainData as $faqBox) {
        $pTitle = $faqBox["pTitle"];
        $pList = $faqBox["pList"];
        // HTML
        echo "<div class='py-3'>";
        echo "<h4 class='m-0 pb-3'>$pTitle</h4>";
        // ciclo foreach -> sull'array che contiene i singoli paragrafi
        foreach ($pList as $p) {
          echo "<p class='m-0 pb-3'>$p</p>";
        }
        echo "</div>";
      }
      ?>
